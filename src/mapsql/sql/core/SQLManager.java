...
public class SQLManager {
	 ...
	 */
	public String execute(SQLCommand command) throws SQLException, FileNotFoundException {
	 ...
	 * @throws FileNotFoundException 
	 */
	public String execute(SQLOperation operation) throws SQLException, FileNotFoundException {
